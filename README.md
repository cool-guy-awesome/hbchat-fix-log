...
Feel free to look around here, the source code is not recommended to run, but you can if you want to I suppose, you'll just have to figure out how to.

I'd like to add that uh, Project Rose's (people I work with) servers got rm -rf --no-preserve-root-ed on 11/4/25. So Let's Chat might take a while longer. 
